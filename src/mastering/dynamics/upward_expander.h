...
class UpwardExpander : public rt::ProcessorBase {
 ...
 private:
  ...
  const UpwardExpanderConfig* adopt_snapshot_for_block() noexcept;
  ...
  std::unique_ptr<rt::RtPublisher<UpwardExpanderConfig>> config_publisher_;
  ...
  ///        before processing.
  const UpwardExpanderConfig* applied_snapshot_ = nullptr;
