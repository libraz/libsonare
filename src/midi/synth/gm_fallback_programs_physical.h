...
constexpr void configure_physical_programs(ProgramOverrides& o) noexcept {
  ...
  o.violin.bowed_string.attack_ms = 41.9837f;
  o.violin.bowed_string.bow_force = 0.0643318f;
  o.violin.bowed_string.bow_position = 0.169028f;
  o.violin.bowed_string.bow_speed = 0.630748f;
  o.violin.bowed_string.damping = 0.0822536f;
  o.violin.bowed_string.release_ms = 147.15f;
  o.violin.bowed_string.brightness = 0.228986f;
  o.violin.bowed_string.rosin = 0.0875388f;
  o.violin.bowed_string.sympathetic = 0.495379f;
  o.violin.bowed_string.vel_to_speed = 0.312461f;
  ...
  o.string_ensemble_1.bowed_string.sympathetic = 0.738632f;
  ...
  o.string_ensemble_1.bowed_string.attack_ms = 22.9484f;
  o.string_ensemble_1.bowed_string.bow_force = 0.0932307f;
  o.string_ensemble_1.bowed_string.bow_position = 0.330712f;
  o.string_ensemble_1.bowed_string.bow_speed = 1.0f;
  o.string_ensemble_1.bowed_string.brightness = 0.092285f;
  o.string_ensemble_1.bowed_string.damping = 0.164415f;
  o.string_ensemble_1.bowed_string.release_ms = 74.0705f;
  o.string_ensemble_1.bowed_string.stribeck = 0.802739f;
  o.string_ensemble_1.drift_rate_hz = 1.69817f;
  o.string_ensemble_1.resonance_q = 1.39165f;
  o.string_ensemble_1.bowed_string.vel_to_speed = 0.312461f;
