...
using sonare_node::node_narrow_finite_float;
...
using sonare_node::node_require_property_type;
...
using sonare_node::RequiredInt64Arg;
using sonare_node::RequiredIntArg;
