...
Napi::Object SonareWrap::Init(Napi::Env env, Napi::Object exports) {
  Napi::Function func = DefineClass(
      env, "Audio",
      {
          ...
          InstanceMethod<&SonareWrap::PeakDbInstance>("peakDb"),
          InstanceMethod<&SonareWrap::RmsDbInstance>("rmsDb"),
          InstanceMethod<&SonareWrap::DcOffsetInstance>("dcOffset"),
          InstanceMethod<&SonareWrap::CrestFactorDbInstance>("crestFactorDb"),
          InstanceMethod<&SonareWrap::SilenceRatioInstance>("silenceRatio"),
          InstanceMethod<&SonareWrap::TruePeakDbInstance>("truePeakDb"),
          InstanceMethod<&SonareWrap::DetectClippingInstance>("detectClipping"),
          InstanceMethod<&SonareWrap::DynamicRangeInstance>("dynamicRange"),
          InstanceMethod<&SonareWrap::SpectrumInstance>("spectrum"),
          InstanceMethod<&SonareWrap::SpectrumFrameInstance>("spectrumFrame"),
  ...
  exports.Set(
      ...
      Napi::Function::New(env, &SonareWrap::RenderPercussiveEvents, "renderPercussiveEvents"));
  ...
  exports.Set(
      ...
      Napi::Function::New(env, &SonareWrap::VoiceCharacterPresetId, "voiceCharacterPresetId"));
  ...
  exports.Set("masteringInsertNames",
              Napi::Function::New(env, &SonareWrap::MasteringInsertNames, "masteringInsertNames"));
  ...
  exports.Set("masteringRepairDeclickStereo",
              Napi::Function::New(env, &SonareWrap::MasteringRepairDeclickStereo,
  ...
  exports.Set("masteringRepairDecrackleStereo",
              Napi::Function::New(env, &SonareWrap::MasteringRepairDecrackleStereo,
  ...
  exports.Set("masteringRepairDereverbClassicalLinked",
              Napi::Function::New(env, &SonareWrap::MasteringRepairDereverbClassicalLinked,
  ...
  exports.Set("melDelta", Napi::Function::New(env, &SonareWrap::MelDelta, "melDelta"));
  ...
  exports.Set("griffinLim", Napi::Function::New(env, &SonareWrap::GriffinLim, "griffinLim"));
  ...
  exports.Set("spectralFlux", Napi::Function::New(env, &SonareWrap::SpectralFlux, "spectralFlux"));
  ...
  exports.Set(
      ...
      Napi::Function::New(env, &SonareWrap::SegmentCrossSimilarity, "segmentCrossSimilarity"));
  exports.Set(
      "segmentRecurrenceMatrix",
      Napi::Function::New(env, &SonareWrap::SegmentRecurrenceMatrix, "segmentRecurrenceMatrix"));
  exports.Set(
      "segmentRecurrenceToLag",
      Napi::Function::New(env, &SonareWrap::SegmentRecurrenceToLag, "segmentRecurrenceToLag"));
  exports.Set(
      "segmentLagToRecurrence",
      Napi::Function::New(env, &SonareWrap::SegmentLagToRecurrence, "segmentLagToRecurrence"));
  exports.Set("segmentSubsegment",
              Napi::Function::New(env, &SonareWrap::SegmentSubsegment, "segmentSubsegment"));
  exports.Set("segmentAgglomerative",
              Napi::Function::New(env, &SonareWrap::SegmentAgglomerative, "segmentAgglomerative"));
  exports.Set("segmentPathEnhance",
              Napi::Function::New(env, &SonareWrap::SegmentPathEnhance, "segmentPathEnhance"));
  ...
  exports.Set("tone", Napi::Function::New(env, &SonareWrap::Tone, "tone"));
  ...
  exports.Set("splitSilenceCommonWithReport",
              Napi::Function::New(env, &SonareWrap::SplitSilenceCommonWithReport,
  ...
  exports.Set("onsetBacktrack",
              Napi::Function::New(env, &SonareWrap::OnsetBacktrack, "onsetBacktrack"));
