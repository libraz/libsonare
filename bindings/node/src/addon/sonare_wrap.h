...
class SonareWrap : public Napi::ObjectWrap<SonareWrap> {
 ...
 private:
  ...
  static Napi::Value DetectBoundaries(const Napi::CallbackInfo& info);
  ...
  static Napi::Value MasteringPlatformNames(const Napi::CallbackInfo& info);
  ...
  static Napi::Value MasteringDynamicsCompressor(const Napi::CallbackInfo& info);
  static Napi::Value MasteringDynamicsGate(const Napi::CallbackInfo& info);
  static Napi::Value MasteringDynamicsTransientShaper(const Napi::CallbackInfo& info);
  ...
  static Napi::Value MasteringRepairDecrackleStereo(const Napi::CallbackInfo& info);
  ...
  static Napi::Value MasteringRepairNoiseBandBins(const Napi::CallbackInfo& info);
