...
- **Instruments & synthesis** — built-in oscillator synth, patch-driven NativeSynth (16 synthesis engines, incl. physically-modeled piano / harpsichord / strings / winds — being tuned over time), and a GS-compatible SoundFont (SF2) player. → [API](https://libsonare.libraz.net/docs/wasm)
