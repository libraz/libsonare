...
int cmd_analyze(const CliArgs& args, const Audio& audio) {
  ...
  if (args.json_output) {
    ...
    json.begin_object()
        .kv("bpm", r.bpm)
        .kv("bpm_confidence", r.bpm_confidence)
        .key("key")
        .begin_object()
    ...
    json.end_array()
        ...
        .key("dynamics")
        .begin_object()
        .kv("dynamic_range_db", r.dynamics.dynamic_range_db)
        .kv("loudness_range_db", r.dynamics.loudness_range_db)
        .kv("crest_factor", r.dynamics.crest_factor)
        .kv("is_compressed", r.dynamics.is_compressed)
        .end_object()
        .key("rhythm")
        .begin_object()
        .kv("syncopation", r.rhythm.syncopation)
        .kv("groove_type", r.rhythm.groove_type)
        .kv("pattern_regularity", r.rhythm.pattern_regularity)
        .end_object()
        .kv("form", r.form)
        .end_object()
        .print();
