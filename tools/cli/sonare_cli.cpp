...
const std::vector<CommandInfo>& get_commands() {
  static std::vector<CommandInfo> commands = {
      ...
      {"pitch-correct-timevarying", "Track pYIN contour and correct toward a note or scale",
       cmd_pitch_correct_timevarying, true},
      {"note-move", "Move one note region", cmd_note_move, true},
