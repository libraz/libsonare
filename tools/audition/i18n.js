...
const STRINGS = {
  en: {
    ...
    'keys.drag': 'Drag across a picture to mark a passage — play stays inside it, and loop repeats it. A click seeks; a click outside the passage leaves it. Drag the playhead itself to scrub.',
    'keys.bankMove': 'move through the rows',
    'keys.bankEnds': 'first / last',
    'keys.bankOpen': 'listen to this voice',
    'keys.bankFind': 'find',

    'pick.find': 'find a voice',
    'pick.findPlaceholder': 'name, program number, engine, patch',
    'pick.legend': 'The bar is how far the calibration has got. A number is how many listening notes it has; empty means nobody has listened yet.',
    'pick.notes': '{n} listening note(s)',
    'pick.prefer': '{n} put forward to keep',
    'pick.structure': 'res',
    'pick.structure.long': 'the structural residual has been diagnosed',
    'pick.music': 'ear',
    'pick.music.long': 'somebody listened and said it is the instrument',
    'pick.playOnly': 'no reference',
    'pick.current': 'current',
    'pick.stale': 'stale — the voice moved under it',
    'pick.unverified': 'unverified — a shared unit moved',
    'keys.voice': 'pick a voice',
    ...
    'transport.rewindTitle': 'To the start of the marked passage, or of the take when none is marked',
    'transport.loop': 'loop',
    'transport.loopTitle': 'Repeat the marked passage, or the whole take when none is marked',
    'transport.clearRegion': 'play the whole take again',
  ...
  ja: {
    ...
    'keys.drag': '波形やスペクトログラムをドラッグすると範囲を選べます。以後の再生はその範囲の中だけで、ループもその範囲を繰り返します。クリックで頭出し、範囲の外をクリックすると範囲が外れます。再生位置の線そのものをつかむとスクラブできます。',
    'keys.bankMove': '行を移動',
    'keys.bankEnds': '先頭 / 末尾',
    ...
    'pick.find': '音色を探す',
    'pick.findPlaceholder': '名前・プログラム番号・エンジン・パッチ',
    'pick.legend': 'バーは校正がどこまで進んだか。数字は試聴メモの件数で、空欄はまだ誰も聴いていないという意味です。',
    'pick.notes': '試聴メモ {n} 件',
    'pick.prefer': '推薦 {n} 件',
    'pick.structure': '構造',
    'pick.structure.long': '構造残差が診断済み',
    'pick.music': '耳',
    'pick.music.long': '人が聴いて「その楽器だ」と言った',
    'pick.playOnly': 'リファレンス無し',
    'pick.current': '有効',
    'pick.stale': '失効 — 音色が動いた',
    'pick.unverified': '未確認 — 共有ユニットが動いた',
    'keys.voice': '音色を選ぶ',
    ...
    'transport.loop': 'ループ',
    'transport.loopTitle': '範囲を指定していればその範囲を、なければテイク全体を繰り返します',
    'transport.clearRegion': 'テイク全体を再生する',
